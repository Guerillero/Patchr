 ...
 *   neighboring rights to the modifications that have been made to this library.
 *   You can receive a full version of this license at
 *   
  ...
  public String diff_prettyHtml(LinkedList<Diff> diffs) {
    ...
    for (Diff aDiff : diffs) {
      ...
      case INSERT:
        ...
        break;
      case DELETE:
        html.append("<font color=\"red\">").append(text)
            .append("</font>");
        break;
      case EQUAL:
